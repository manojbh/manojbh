...
🌐 **Portfolio:** [manojbh.github.io](https://manojbh.github.io/)

## 🚀 What I do

- 📱 Cross-platform mobile apps with **Flutter** (iOS & Android)
- 🔧 Backend systems & REST APIs with **Django, FastAPI & Laravel**
- 🎨 Frontend applications with **Angular & React**
- ☁️ Cloud infrastructure & CI/CD with **AWS, Docker, Terraform & GitHub Actions**
- 🤖 **AI agents** for task automation
- 🏢 ERP customization with **Odoo**
